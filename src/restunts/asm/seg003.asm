...
loc_1CF8F:
    ...
    db 144
loc_1CF92:
    mov     [bp+var_20], (offset game3dshapes.shape3d_numverts+3B2h)
loc_1CF97:
    push    si
    push    di
    lea     di, [bp+var_26]
...
loc_1CFBF:
    ...
    jmp     short loc_1D036
loc_1D01A:
    mov     [bp+var_20], (offset game3dshapes.shape3d_numverts+7D2h)
    jmp     loc_1CF97
loc_1D022:
    mov     [bp+var_20], (offset game3dshapes.shape3d_numverts+7E8h)
    jmp     loc_1CF97
loc_1D02A:
    mov     [bp+var_20], (offset game3dshapes.shape3d_numverts+7FEh)
    jmp     loc_1CF97
loc_1D032:
    mov     [bp+var_13], 0
loc_1D036:
...
loc_1DEC4:
    ...
    db 144
loc_1DEE4:
    mov     [bp+var_16], offset logo2shape
loc_1DEE9:
    mov     ax, 400h
    sub     ax, [bp+arg_0]
    mov     [bp+var_1C], ax
...
loc_1DF7E:
    ...
    sub     ax, [bp+arg_4]
    mov     [bp+var_18], ax
    mov     [bp+var_16], offset bravshape
    cmp     word_44984, 0
    jz      short loc_1DFA4
    lea     ax, [bp+var_8]
    mov     [bp+var_14], ax
